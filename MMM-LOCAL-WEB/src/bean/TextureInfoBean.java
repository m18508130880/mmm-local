...
public class TextureInfoBean extends RmiBean
{
	public final static long	serialVersionUID	= RmiBean.RMI_TEXTURE_INFO;
	...
	public TextureInfoBean()
	{
		super.className = "TextureInfoBean";
	}
